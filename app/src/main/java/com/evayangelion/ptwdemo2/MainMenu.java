...
//这个Activity是地图主界面并带有导航栏避免空白跳转
public class MainMenu extends AppCompatActivity implements LocationSource,
        ...
        public boolean onNavigationItemSelected(@NonNull MenuItem item) {
            switch (item.getItemId()) {
                case R.id.navigation_home:
                    Intent intent_home=new Intent(MainMenu.this,MainMenu.class);
